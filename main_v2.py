...
def main():
    print("LinkedIn Knowledge Base — v2 (agent ingestion loop)")
    print("Ask a question or say what to save. Keep it simple.\n")
    print("  site:linkedin.com AIEngg capstone Lavanya    — save posts (agent loop, max depth 2)")
